...
function menulayout() {
  ...
  $('#mobile-collapse').on('click', function (o) {
    e > 991
      ...
      : ($('.pcoded-navbar').toggleClass('mob-open'), o.stopPropagation())
  }),
...
$(document).ready(function () {
  ...
  if (!$('.pcoded-navbar').hasClass('theme-horizontal')) {
    s = $(window)[0].innerWidth
    if ($('.navbar-content')[0])
      if (s < 992 || $('.pcoded-navbar').hasClass('menupos-static'))
  ...
  $('.card-option .close-card').on('click', function () {
    ...
    $('.card-option .minimize-card').on('click', function () {
      ...
      o.hasClass('full-card') || $(o).css('height', 'auto'),
    ...
    $('.card-option .full-card').on('click', function () {
      var e = $(this),
        o = $(e.parents('.card'))
      if (
        (o.toggleClass('full-card'),
        $(this).children('a').children('span').toggle(),
        o.hasClass('full-card'))
      ) {
    ...
    $('.event-btn').on('click', function () {
      ...
      e.children('.spinner-border').show(),
        ...
        setTimeout(function () {
          e.children('.spinner-border').hide(),
            e.children('.spinner-grow').hide(),
            e.children('.load-text').hide(),
            e.children('.btn-text').show(),
        ...
        ((e = $.extend({}, o, e)),
        {
          ...
          HandleSubMenuTrigger: function () {
            var o = $(window),
              d = o.width()
            if (
              1 == $('.pcoded-navbar').hasClass('theme-horizontal') ||
              1 == $('.pcoded-navbar').hasClass('theme-horizontal-dis')
            )
              if (d >= 992) {
                var n = $(
                    ...
                    console.log('123123'),
                      0 === o
                        ? $(this).hasClass('pcoded-trigger')
                          ...
                          : ($(
                              'pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > .pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger',
                            )
            ...
            switch (e.SubMenuTrigger) {
              case 'click':
                $('.pcoded-navbar .pcoded-hasmenu').removeClass('is-hover'),
                  $(
                    '.pcoded-inner-navbar > .pcoded-hasmenu > .pcoded-submenu > li > .pcoded-submenu > li',
                  ).on('click', function (e) {
                    e.stopPropagation()
                    var o = $(this).closest('.pcoded-submenu').length
                    0 === o
                  ...
                  $(
                    '.pcoded-inner-navbar > .pcoded-hasmenu > .pcoded-submenu > li',
                  ).on('click', function (e) {
                    e.stopPropagation()
                    var o = $(this).closest('.pcoded-submenu').length
                    0 === o
          ...
          HandleMenuTrigger: function () {
            ...
            if (d >= 992) {
              if (1 == $('.pcoded-navbar').hasClass('theme-horizontal')) {
                var n = $('.theme-horizontal .pcoded-inner-navbar > li')
                n.off('click')
                  .off('mouseenter mouseleave')
                  .hover(
                    function () {
                      if (
                        ...
                        var e = $('.pcoded-submenu:first', this),
                          ...
                          i = d + n <= s
                        if (i) $(this).removeClass('edge')
                        else {
                          var r = $('.sidenav-inner').attr('style')
                          $('.sidenav-inner').css({
                            'margin-left':
                              parseInt(r.slice(12, r.length - 3)) - 80,
                          }),
  ...
  $('.pcoded-navbar .close').on('click', function () {
    var e = $(this)
    e.parents('.card').fadeOut('slow').remove()
  }),
