!(function (e, t) {
  ...
  function v(e, t) {
    for (var n, r, i, o, a, s, l, c = [], u = 0, f = e.length; u < f; u++)
      (r = e[u]).style &&
        ((n = r.style.display),
        t
          ? ('none' === n &&
              ((c[u] = Ne.get(r, 'display') || null),
              c[u] || (r.style.display = '')),
            '' === r.style.display &&
              Ie(r) &&
              (c[u] =
                ...
                (l = $e[s]) ||
                  ...
                  'none' === l && (l = 'block'),
                  ($e[s] = l)))))
          : 'none' !== n && ((c[u] = 'none'), Ne.set(r, 'display', n)))
  ...
  function x(e, t, n, i, o) {
    ...
    for (p.textContent = '', h = 0; (a = d[h++]); )
      ...
      else if (((u = Ye(a)), (s = y(p.appendChild(a), 'script')), u && b(s), n))
            ...
            if (1 & e.isTrigger && this[t]) {
              ...
              o &&
                (Ne.set(
                  ...
                  t,
                  he.event.trigger(
                    he.extend(o.shift(), he.Event.prototype),
                    o,
                    this,
                  ),
                ),
  ...
  function D(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Ne.hasData(e) &&
        ((o = Ne.access(e)), (a = Ne.set(t, o)), (c = o.events))
      )
        for (i in (delete a.handle, (a.events = {}), c))
          for (n = 0, r = c[i].length; n < r; n++) he.event.add(t, i, c[i][n])
      He.hasData(e) &&
        ((s = He.access(e)), (l = he.extend({}, s)), He.set(t, l))
    }
  }
  function j(e, t, r, i) {
    t = te.apply([], t)
    var o,
      ...
      h = t[0],
      g = ue(h)
    if (g || (1 < p && 'string' == typeof h && !ce.checkClone && rt.test(h)))
    ...
    if (
      ...
      for (l = (s = he.map(y(o, 'script'), L)).length; f < p; f++)
        (c = o),
          f !== d &&
            ((c = he.clone(c, !0, !0)), l && he.merge(s, y(c, 'script'))),
          r.call(e[f], c, f)
      if (l)
        for (u = s[s.length - 1].ownerDocument, he.map(s, A), f = 0; f < l; f++)
          (c = s[f]),
            ze.test(c.type || '') &&
  ...
  function O(e, t, n) {
    for (var r, i = t ? he.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || he.cleanData(y(r)),
        r.parentNode &&
          (n && Ye(r) && b(y(r, 'script')), r.parentNode.removeChild(r))
    return e
  }
  function N(e, t, n) {
    var r,
  ...
  function P(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      'margin' === n && (l += he.css(e, n + qe[a], !0, i)),
        r
          ? ('content' === n && (l -= he.css(e, 'padding' + qe[a], !0, i)),
            'margin' !== n &&
              (l -= he.css(e, 'border' + qe[a] + 'Width', !0, i)))
          : ((l += he.css(e, 'padding' + qe[a], !0, i)),
            'padding' !== n
              ? (l += he.css(e, 'border' + qe[a] + 'Width', !0, i))
              : (s += he.css(e, 'border' + qe[a] + 'Width', !0, i)))
    return (
      !r &&
        0 <= o &&
        (l +=
  ...
  function M(e, t, n) {
    ...
    return (
      ((!ce.boxSizingReliable() && i) ||
        'auto' === a ||
        (!parseFloat(a) && 'inline' === he.css(e, 'display', !1, r))) &&
        e.getClientRects().length &&
        ((i = 'border-box' === he.css(e, 'boxSizing', !1, r)),
        (o = s in e) && (a = e[s])),
      (a = parseFloat(a) || 0) +
        P(e, t, n || (i ? 'border' : 'content'), o, r, a) +
        'px'
    )
  }
  ...
  function X() {
    mt &&
      (!1 === J.hidden && e.requestAnimationFrame
        ? e.requestAnimationFrame(X)
        : e.setTimeout(X, he.fx.interval),
      he.fx.tick())
  }
  function Y() {
    return (
  ...
  function I(e, t, n) {
    for (
      var r,
        i = (F.tweeners[t] || []).concat(F.tweeners['*']),
        o = 0,
        a = i.length;
      o < a;
      o++
  ...
  function F(e, t, n) {
    ...
    for (
      ...
      if ((r = F.prefilters[o].call(c, e, u, c.opts)))
        return (
          ue(r.stop) &&
            (he._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
          r
        )
    return (
      he.map(u, I, c),
  ...
  ;(he.fn = he.prototype = {
    ...
    'function' == typeof Symbol &&
      (he.fn[Symbol.iterator] = Q[Symbol.iterator]),
    he.each(
  ...
  var me = (function (e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : X) !== O && j(t), (t = t || O), H)
      ) {
        if (11 !== h && (l = ve.exec(e)))
          if ((i = l[1])) {
            if (9 === h) {
        ...
        if (
          ...
          if (((u = e), (p = t), 1 === h && ce.test(e))) {
            for (
              ...
              c[o] = '#' + s + ' ' + d(c[o])
            ;(u = c.join(',')), (p = (ye.test(e) && f(t.parentNode)) || t)
          }
          try {
      ...
      return (
        ...
        r(function (r, s, l, c) {
          var u,
            ...
            y = !e || (!r && n) ? v : m(v, d, e, l, c),
            b = i ? (a || (r ? e : g || o) ? [] : s) : y
          if ((i && i(y, b, l, c), o))
            for (u = m(b, h), o(u, [], l, c), f = u.length; f--; )
              (p = u[f]) && (b[h[f]] = !(y[h[f]] = p))
          if (r) {
            if (a || e) {
              if (a) {
          ...
          } else (b = m(b === s ? b.splice(g, b.length) : b)), a ? a(null, s, b, c) : Q.apply(s, b)
        })
      )
    }
    function y(e) {
      for (
        ...
        if ((n = w.relative[e[s].type])) u = [h(g(u), n)]
        else {
    ...
    try {
      Q.apply((V = J.call(X.childNodes)), X.childNodes),
        V[X.childNodes.length].nodeType
    } catch (b) {
      Q = {
        apply: V.length
          ? function (e, t) {
            ...
            ? function (e, t) {
                ...
                return (
                  ...
                  (!x.sortDetached && t.compareDocumentPosition(e) === n)
                    ? e === O || (e.ownerDocument === X && M(X, e))
                      ? -1
                      : t === O || (t.ownerDocument === X && M(X, t))
                      ? 1
                      : A
                      ? Z(A, e) - Z(A, t)
                      : 0
    ...
    (t.matchesSelector = function (e, n) {
      ...
      return 0 < t(n, O, null, [e]).length
    }),
    (t.contains = function (e, t) {
      return (e.ownerDocument || e) !== O && j(e), M(e, t)
    }),
    (t.attr = function (e, t) {
      ;(e.ownerDocument || e) !== O && j(e)
      var n = w.attrHandle[t.toLowerCase()],
        r = n && z.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0
      return void 0 !== r
        ? r
        : x.attributes || !H
        ? e.getAttribute(t)
                  ...
                  if (((h = [a ? m.firstChild : m.lastChild]), a && y)) {
                    ...
                    (y &&
                      (b = d =
                        (c =
                          (u =
                            (f = (p = t)[q] || (p[q] = {}))[p.uniqueID] ||
                            (f[p.uniqueID] = {}))[e] || [])[0] === Y && c[1]),
                    !1 === b)
                  )
                    for (
                      ;
    ...
    return (
      ...
      (S = t.compile = function (e, n) {
        ...
        if (!p) {
          for (n || (n = C(e)), i = n.length; i--; )
            (p = y(n[i]))[q] ? u.push(p) : f.push(p)
          ;(p = $(
            e,
            ((o = f),
            (s = 0 < (a = u).length),
            (l = 0 < o.length),
            (c = function (e, n, r, i, c) {
              var u,
                f,
                p,
                d = 0,
              ...
              for (
                ...
                if (l && u) {
                  for (
                    f = 0, n || u.ownerDocument === O || (j(u), (r = !H));
                    (p = o[f++]);
                ...
                s && ((u = !p && u) && d--, e && g.push(u))
              }
              if (((d += h), s && h !== d)) {
                for (f = 0; (p = a[f++]); ) p(g, v, n, r)
                if (e) {
                  if (0 < d) for (; h--; ) g[h] || v[h] || (v[h] = K.call(i))
                  v = m(v)
                }
                Q.apply(i, v),
                  c && !e && 0 < v.length && 1 < d + a.length && t.uniqueSort(i)
              }
              return c && ((Y = x), (L = y)), g
            }),
            s ? r(c) : c),
      ...
      (x.sortStable = q.split('').sort(U).join('') === q),
    ...
    if (((n = n || we), 'string' == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          he.merge(
            this,
            he.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : J, !0),
          ),
      ...
      return (
        (i = J.getElementById(r[2])) && ((this[0] = i), (this.length = 1)), this
      )
    }
    return e.nodeType
      ...
      function (e, t) {
        he.fn[e] = function (n, r) {
          ...
          return (
            ...
            1 < this.length &&
              (Ce[e] || he.uniqueSort(i), Ee.test(e) && i.reverse()),
            this.pushStack(i)
          )
        }
      },
  ...
  ;(he.Callbacks = function (e) {
    ...
    var i,
      ...
      u = -1,
      f = function () {
        for (s = s || e.once, a = i = !0; c.length; u = -1)
      ...
      when: function (e) {
        var t = arguments.length,
          ...
          a = function (e) {
            return function (n) {
              ;(r[e] = this),
                (i[e] = 1 < arguments.length ? ee.call(arguments) : n),
                --t || o.resolveWith(r, i)
            }
          }
        if (
    ...
    he.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = He.get(o)), 1 === o.nodeType && !Ne.get(o, 'hasDataAttrs'))
          ) {
            for (n = a.length; n--; )
              a[n] &&
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = Ne.access(e, t, he.makeArray(n)))
                : r.push(n)),
            r || []
          )
      },
  ...
  Xe.attachShadow &&
    (Ye = function (e) {
      return (
        he.contains(e.ownerDocument, e) || e.getRootNode(Be) === e.ownerDocument
      )
    })
  var Ie = function (e, t) {
      return (
        'none' === (e = t || e).style.display ||
        ('' === e.style.display && Ye(e) && 'none' === he.css(e, 'display'))
      )
    },
    Fe = function (e, t, n, r) {
      var i,
  ...
  var Ke,
    Ge,
    Qe = /<|&#?\w+;/
  ;(Ke = J.createDocumentFragment().appendChild(J.createElement('div'))),
    (Ge = J.createElement('input')).setAttribute('type', 'radio'),
    Ge.setAttribute('checked', 'checked'),
    Ge.setAttribute('name', 't'),
    Ke.appendChild(Ge),
    (ce.checkClone = Ke.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (Ke.innerHTML = '<textarea>x</textarea>'),
    (ce.noCloneChecked = !!Ke.cloneNode(!0).lastChild.defaultValue)
  var Je = /^key/,
      ...
      if (m)
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            i && he.find.matchesSelector(Xe, i),
        ...
        for (c = (t = (t || '').match(Se) || ['']).length; c--; )
          if (
            ...
            a &&
              ...
              delete l[d])
          } else for (d in l) he.event.remove(e, d + t[c], n, r, !0)
  ...
  he.extend({
    ...
    clone: function (e, t, n) {
      ...
      return 0 < (a = y(u, 'script')).length && b(a, !f && y(e, 'script')), u
    },
  ...
  he.extend({
    ...
    he.each(['height', 'width'], function (e, t) {
      he.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !ft.test(he.css(e, 'display')) ||
    ...
    he.each({ margin: '', padding: '', border: 'Width' }, function (e, t) {
      ;(he.cssHooks[e + t] = {
        ...
        'margin' !== e && (he.cssHooks[e + t].set = W)
    }),
    he.fn.extend({
      css: function (e, t) {
        return Ae(
      ...
      _default: {
        ...
        set: function (e) {
          he.fx.step[e.prop]
            ? he.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!he.cssHooks[e.prop] && null == e.elem.style[R(e.prop)])
            ? (e.elem[e.prop] = e.now)
      ...
      function (e, t, n) {
        ...
        if ((l = !he.isEmptyObject(t)) || !he.isEmptyObject(d))
          for (r in (f &&
            ...
            null == (c = m && m.display) && (c = Ne.get(e, 'display')),
          ...
          d))
            l ||
              (m
                ...
                : (m = Ne.access(e, 'fxshow', { display: c })),
              o && (m.hidden = !g),
              g && v([e], !0),
              p.done(function () {
                for (r in (g || v([e]), Ne.remove(e, 'fxshow'), d))
                  he.style(e, r, d[r])
              })),
              (l = I(g ? m[r] : 0, r, p)),
              r in m ||
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && he.isXMLDoc(e)) ||
                (i =
                  ...
                  (he.expr.match.bool.test(t) ? wt : void 0)),
              void 0 !== n
                ? null === n
  ...
  he.fn.extend({
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Et.test(e.nodeName) || (Ct.test(e.nodeName) && e.href)
              ? 0
              : -1
          },
        },
    ...
    he.fn.extend({
      addClass: function (e) {
        ...
        if ((t = U(e)).length)
          for (; (n = this[l++]); )
            if (((i = _(n)), (r = 1 === n.nodeType && ' ' + $(i) + ' '))) {
              for (a = 0; (o = t[a++]); )
                r.indexOf(' ' + o + ' ') < 0 && (r += o + ' ')
              i !== (s = $(r)) && n.setAttribute('class', s)
            }
        return this
      },
      ...
      toggleClass: function (e, t) {
        ...
        return 'boolean' == typeof t && r
          ...
          : this.each(function () {
              var t, i, o, a
              if (r)
                for (i = 0, o = he(this), a = U(e); (t = a[i++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t)
              else
                (void 0 !== e && 'boolean' !== n) ||
                  ((t = _(this)) && Ne.set(this, '__className__', t),
                  this.setAttribute &&
                    this.setAttribute(
                      'class',
                      t || !1 === e ? '' : Ne.get(this, '__className__') || '',
                    ))
            })
      },
      hasClass: function (e) {
        var t,
          ...
          r = 0
        for (t = ' ' + e + ' '; (n = this[r++]); )
          if (1 === n.nodeType && -1 < (' ' + $(_(n)) + ' ').indexOf(t))
            return !0
        return !1
      },
    })
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !f.noBubble && !fe(r)) {
          for (
            l = f.delegateType || h, kt.test(l + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            d.push(a), (s = a)
      ...
      ajax: function (t, n) {
        function r(t, n, r, s) {
          ...
          u ||
            ...
            c
              ? (h.ifModified &&
                  ((w = E.getResponseHeader('Last-Modified')) &&
                    (he.lastModified[o] = w),
                  (w = E.getResponseHeader('etag')) && (he.etag[o] = w)),
                204 === t || 'HEAD' === h.type
                  ? (T = 'nocontent')
                  : 304 === t
                  ? (T = 'notmodified')
                  : ((T = x.state), (p = x.data), (c = !(d = x.error))))
            ...
            E.statusCode(b),
            (b = void 0),
            f && m.trigger(c ? 'ajaxSuccess' : 'ajaxError', [E, h, c ? p : d]),
            y.fireWith(g, [E, T]),
            f &&
        ...
        h.ifModified &&
          (he.lastModified[o] &&
            E.setRequestHeader('If-Modified-Since', he.lastModified[o]),
          he.etag[o] && E.setRequestHeader('If-None-Match', he.etag[o])),
        ...
        if (h.beforeSend && (!1 === h.beforeSend.call(g, E, h) || u))
          return E.abort()
        if (
          ((T = 'abort'),
          y.add(h.complete),
          ...
          if (((E.readyState = 1), f && m.trigger('ajaxSend', [E, h]), u))
            return E
          h.async &&
            0 < h.timeout &&
  ...
  he.ajaxSetup({
    ...
    he.ajaxPrefilter('json jsonp', function (t, n, r) {
      ...
      if (s || 'jsonp' === t.dataTypes[0])
        return (
          (i = t.jsonpCallback = ue(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
          ...
          r.always(function () {
            void 0 === o ? he(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), Vt.push(i)),
              a && ue(o) && o(a[0]),
              (a = o = void 0)
          }),
          'script'
    ...
    (ce.createHTMLDocument =
      (((zt = J.implementation.createHTMLDocument('').body).innerHTML =
        '<form></form><form></form>'),
    ...
    (he.parseHTML = function (e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          t ||
            (ce.createHTMLDocument
              ? (((r = (t = J.implementation.createHTMLDocument(
                  '',
                )).createElement('base')).href = J.location.href),
  ...
  return (
    (he.noConflict = function (t) {
      return (
        e.$ === he && (e.$ = Qt), t && e.jQuery === he && (e.jQuery = Gt), he
      )
    }),
    t || (e.jQuery = e.$ = he),
    he
  ...
  (function (e, t) {
    ...
    function c(e) {
      return t(l(e)).left + r(e).scrollLeft
    }
    function u(e) {
    ...
    function m(e, t) {
      ...
      var i = g(e)
      return (
        (e = i === (null == (r = e.ownerDocument) ? void 0 : r.body)),
        (r = n(i)),
        (i = e ? [r].concat(r.visualViewport || [], f(i) ? i : []) : i),
        (t = t.concat(i)),
        e ? t : t.concat(m(h(i)))
      )
    }
    ...
    function y(e) {
      ...
      if (
        r &&
        ('html' === s(r) || ('body' === s(r) && 'static' === u(r).position))
      )
        return t
      if (!r)
        e: {
    ...
    function C(e, i) {
      if ('viewport' === i) {
        ...
        i &&
          ...
          (e = E((e = { width: s, height: a, x: f + c(e), y: p })))
      } else o(i) ? (((e = t(i)).top += i.clientTop), (e.left += i.clientLeft), (e.bottom = e.top + i.clientHeight), (e.right = e.left + i.clientWidth), (e.width = i.clientWidth), (e.height = i.clientHeight), (e.x = e.left), (e.y = e.top)) : ((p = l(e)), (e = l(p)), (s = r(p)), (i = null == (a = p.ownerDocument) ? void 0 : a.body), (a = I(e.scrollWidth, e.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0)), (f = I(e.scrollHeight, e.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0)), (p = -s.scrollLeft + c(p)), (s = -s.scrollTop), 'rtl' === u(i || e).direction && (p += I(e.clientWidth, i ? i.clientWidth : 0) - a), (e = E({ width: a, height: f, x: p, y: s })))
      return e
    }
    function S(e, t, n) {
      return (
    ...
    function j(e, n) {
      ...
      var o = r.boundary,
        ...
        s = void 0 === (o = r.rootBoundary) ? 'viewport' : o
      ...
      ;(c = e.rects.popper),
        (a = S(
          i((u = e.elements[u ? ('popper' === o ? 'reference' : 'popper') : o]))
            ? u
        ...
        (s = 'popper' === o ? c : s)
      var p = {
        top: a.top - s.top + r.top,
        bottom: s.bottom - a.bottom + r.bottom,
        left: a.left - s.left + r.left,
        right: s.right - a.right + r.right,
      }
    ...
    function N(e) {
      ...
      var t = e.defaultModifiers,
        n = void 0 === t ? [] : t,
        r = void 0 === (e = e.defaultOptions) ? _ : e
                ...
                s.orderedModifiers.forEach(function (e) {
                  ...
                  ;(n = void 0 === n ? {} : n),
                    'function' == typeof (e = e.effect) &&
                      ((t = e({ state: s, name: t, instance: u, options: n })),
                      l.push(t || function () {}))
                }),
                u.update()
              )
            ...
            forceUpdate: function () {
              if (!c) {
                ...
                if (O(t, (e = e.popper)))
                  for (
                    s.rects = {
                      reference: p(t, y(e), 'fixed' === s.options.strategy),
                      popper: d(e),
                    },
                      s.reset = !1,
                    ...
                    if (!0 === s.reset) (s.reset = !1), (t = -1)
                      ...
                      ;(r = void 0 === r ? {} : r),
                        ...
                        'function' == typeof e &&
                          (s =
                            e({ state: s, options: r, name: n, instance: u }) ||
                            s)
                    }
              }
            },
    ...
    function H(e) {
      ...
      if (f) {
        var b = y(r),
          ...
          w = 'clientWidth'
        b === n(r) &&
          'static' !== u((b = l(r))).position &&
          ((x = 'scrollHeight'), (w = 'scrollWidth')),
          'top' === o &&
            ((m = 'bottom'), (p -= b[x] - i.height), (p *= c ? 1 : -1)),
          'left' === o &&
            ((g = 'right'), (e -= b[w] - i.width), (e *= c ? 1 : -1))
      }
      return (
        (r = Object.assign({ position: s }, f && K)),
        c
          ? Object.assign(
              {},
              r,
    ...
    var q = ['top', 'bottom', 'right', 'left'],
      X = q.reduce(function (e, t) {
        return e.concat([t + '-start', t + '-end'])
      }, []),
      Y = [].concat(q, ['auto']).reduce(function (e, t) {
      ...
      z = {
        ...
        effect: function (e) {
          ...
          return (
            ...
            a && s.addEventListener('resize', r.update, U),
            function () {
              o &&
                l.forEach(function (e) {
                  e.removeEventListener('scroll', r.update, U)
                }),
                a && s.removeEventListener('resize', r.update, U)
            }
          )
        },
        data: {},
            ...
            ;(u = w((n = t.options.placement))),
              (o =
                ...
                (u !== n && f
                  ...
                  : [R(n)]))
            var d = [n].concat(o).reduce(function (e, n) {
              return e.concat(
                'auto' === w(n)
                  ? (function (e, t) {
                      void 0 === t && (t = {})
      ...
      ne = {
        ...
        fn: function (e) {
          ...
          var r = n.mainAxis,
            i = void 0 === r || r,
            o = void 0 !== (r = n.altAxis) && r
          r = void 0 === (r = n.tether) || r
          ...
          var c = t.placement.split('-')[1],
            u = !c,
            f = k(n)
          ;(n = 'x' === f ? 'y' : 'x'), (a = t.modifiersData.popperOffsets)
          ...
          if (((s = { x: 0, y: 0 }), a)) {
            if (i || o) {
              ...
              ;(c = 'start' === c ? -h[b] : -p[b]),
                (h = t.elements.arrow),
                (h = r && h ? d(h) : { width: 0, height: 0 })
              var L = t.modifiersData['arrow#persistent']
                ? t.modifiersData['arrow#persistent'].padding
                : { top: 0, right: 0, bottom: 0, left: 0 }
              ;(m = L[m]),
                (v = L[v]),
                (h = I(0, F(p[b], h[b]))),
                (S = u ? p[b] / 2 - C - h - m - g : S - h - m - g),
                (p = u ? -p[b] / 2 + C + h + v + g : c + h + v + g),
                ...
                i &&
                  ...
                  (s[f] = i - x)),
                o &&
                  ((i = (o = a[n]) + l['x' === f ? 'top' : 'left']),
                  (l = o - l['x' === f ? 'bottom' : 'right']),
                  (i = r ? F(i, u) : i),
                  (r = r ? I(l, p) : l),
                  (r = I(i, F(o, r))),
                  (a[n] = r),
        ...
        effect: function (e) {
          ...
          if (
            ...
            if (
              ...
              return
            T(t.elements.popper, e) && (t.elements.arrow = e)
          }
        },
        requires: ['popperOffsets'],
      ...
      oe = N({ defaultModifiers: [z, V, G, Q] }),
      ae = [z, V, G, Q, J, te, ne, re, ie],
      se = N({ defaultModifiers: ae })
    ;(e.applyStyles = Q),
      (e.arrow = re),
      (e.computeStyles = G),
      (e.createPopper = se),
      ...
      S = function (e) {
        ...
        ;(e.containerWidth = t.clientWidth),
          ...
          t.contains(e.scrollbarXRail) ||
            (o(t, y.element.rail('x')).forEach(function (e) {
              return i(e)
            }),
            t.appendChild(e.scrollbarXRail)),
          t.contains(e.scrollbarYRail) ||
            (o(t, y.element.rail('y')).forEach(function (e) {
              return i(e)
            }),
        ...
        wheel: function (t) {
          function n(e, n) {
            var r = Math.floor(a.scrollTop),
              i = 0 === a.scrollTop,
              o = r + a.offsetHeight === a.scrollHeight,
              s = 0 === a.scrollLeft,
              l = a.scrollLeft + a.offsetWidth === a.scrollWidth
            return (
              !(Math.abs(n) > Math.abs(e) ? i || o : s || l) ||
          ...
          function i(t, n, r) {
            if (!C.isWebKit && a.querySelector('select:focus')) return !0
            if (!a.contains(t)) return !1
            for (var i = t; i && i !== a; ) {
              if (i.classList.contains(y.element.consuming)) return !0
              var o = e(i)
              if (
          ...
          void 0 !== window.onwheel
            ? t.event.bind(a, 'wheel', o)
            : void 0 !== window.onmousewheel && t.event.bind(a, 'mousewheel', o)
        },
        touch: function (t) {
          function n(e, n) {
            ...
            if (a > o) {
              if (
                ...
                return 0 === window.scrollY && n > 0 && C.isChrome
            } else if (
              o > a &&
              ((e < 0 && i === t.contentWidth - t.containerWidth) ||
                (e > 0 && 0 === i))
            )
              return !0
            return !0
